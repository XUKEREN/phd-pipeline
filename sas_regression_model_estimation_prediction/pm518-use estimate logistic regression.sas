/*PM518 - HW4 - estimate OR with CI in logistic regression*/
...
run;
proc print data=hw4a;
run;

/*For models 3 and 4, give the estimated relative risk (OR) for persons */
/*who consume 100g/day of alcohol and smoke 25g/day compared to */
/*those drinking 20g/day of alcohol and smoking 5g/day*/
/*alcohol 0 0 1 0  tobacco 0 1 0 0 */
/*alcohol 0 0 0 1  tobacco 0 0 0 1 */

/*model a*/
proc logistic data = hw4a; 
class age_group(ref = '25-34') / param = glm; 
class tobacco(ref = '0-9') / param = glm; 
class alcohol(ref = '0-39') / param = glm; 
model disease = age_group alcohol tobacco/cl;
estimate 'OR1' alcohol 0 0 1 -1 tobacco 0 1 0 -1 /exp cl;
run;

/*model b*/
/*categorical alcohol was treated as linear variable here without class statement*/
proc logistic data = hw4a; 
class age_group(ref = '25-34') / param = ref; 
class tobacco(ref = '0-9') / param = ref; 
model disease = age_group tobacco alcohol/cl;
estimate 'OR1' alcohol 2 tobacco 0 1 0 -1 /exp cl;
run;
