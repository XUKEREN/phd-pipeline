...
#SBATCH --output=/scratch/kerenxu/output/manta_workflow_%A_%a.out
#SBATCH --error=/scratch/kerenxu/error/manta_workflow_%A_%a.errcd
...
/scratch/kerenxu/wgs.smoking.out/manta.config/$sample_name/runWorkflow.py -j 8
