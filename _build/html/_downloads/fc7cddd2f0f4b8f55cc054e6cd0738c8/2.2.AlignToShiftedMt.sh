...
#SBATCH --output=/scratch/kerenxu/output/AlignToShiftedMt_%A_%a.out
#SBATCH --error=/scratch/kerenxu/error/AlignToShiftedMt_%A_%a.errcd
#SBATCH --job-name=AlignToShiftedMt
#SBATCH -c 15
#SBATCH --ntasks=1
#SBATCH --mem=59G
...
export PATH="/home/rcf-proj3/kx/tools/bwa/:$PATH"
export PATH="/home/rcf-proj3/kx/tools/samtools/samtools-1.10/:$PATH"

srun hostname

cd /scratch2/kerenxu/chrM/
bash_ref_fasta=/dir/kerenxu/refs/GATK_resource_bundle/chrM_ref/Homo_sapiens_assembly38.chrM.shifted_by_8000_bases.fasta
...
## output:
output_fastq="$base.chrM.ShiftedMt.fastq"
output_aligned_bam="$base.chrM.ShiftedMt.mapped.bam"

output_bam_final="$base.AlignToShiftedMt.bam"
metrics_filename="$base.AlignToShiftedMt.metrics"
...
srun gatk --java-options "-Xms55G -Djava.io.tmpdir=/scratch2/kerenxu/tmp" \
      ...
      --OUTPUT $base.AlignToShiftedMt.mba.bam \
...
srun gatk --java-options "-Xms55G -Djava.io.tmpdir=/scratch2/kerenxu/tmp" \
      MarkDuplicates \
      --INPUT $base.AlignToShiftedMt.mba.bam \
      --OUTPUT $base.AlignToShiftedMt.md.bam \
...
srun gatk --java-options "-Xms55G -Djava.io.tmpdir=/scratch2/kerenxu/tmp" \
      SortSam \
      --INPUT $base.AlignToShiftedMt.md.bam \
